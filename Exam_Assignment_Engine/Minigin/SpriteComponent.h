...
namespace dae
{
	...
	public:
		SpriteComponent(const std::string& assetPath, float scale = 1, const b2Vec2& offset = { 0,0 }, float angle = 0, const b2Vec2& rotationCenter = { 0,0 }, const SDL_RendererFlip& flipDir = SDL_FLIP_NONE);
